...
if __name__ == "__main__":
    ...
    with futures.ProcessPoolExecutor(max_workers=3) as executor:
        for _ in range(3):
            executor.submit(fn=doPoissonDistirbutedSimulation, numberOfQubits=numberOfQubits, bases=bases, maxNumberOfIteration=maxNumberOfIteration, experimentalData=listOfExperimentalData, idealMatrix=matrix)
